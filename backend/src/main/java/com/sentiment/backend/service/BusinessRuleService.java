...
public class BusinessRuleService {
    ...
    private static final Map<String, List<String>> DICIONARIO_SETORES = Map.of(
            "LOGÍSTICA", Arrays.asList("entrega", "atraso", "prazo", "correios", "chegou", "frete"),
            ...
            "ATENDIMENTO", Arrays.asList("suporte", "atendente", "demora", "responder", "chat", "telefone")
    );

    // Palavras que indicam urgência crítica
    private static final List<String> ALERTAS_CRITICOS = Arrays.asList("procon", "justiça", "advogado", "processar", "reclame aqui", "polícia");
    ...
    public String gerarSugestao(SentimentType sentimento, String setor) {
        ...
        return switch (setor) {
            case "LOGÍSTICA" -> "Lamentamos o transtorno com a entrega. Vamos verificar com a transportadora agora mesmo.";
